            ...
            >
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="m-2 bg-gray-200 sm:rounded-lg shadow-md">
                        ...
                        <Pagination :pagination="dato39"></Pagination>
                    </div>
                </div>
            </div>
        </div>
