...
class CustomerFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'v35_porciento' => $this->faker->numberBetween($min = 1000, $max = 9000),
            'v25_porciento' => $this->faker->numberBetween($min = 1000, $max = 9000),
            'v20_porciento' => $this->faker->numberBetween($min = 1000, $max = 9000),
