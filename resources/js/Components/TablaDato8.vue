<template>
    <div class="flex justify-center">
        <div class="form-check form-switch">
            <label class="form-check-label inline-block mx-4 text-gray-800" for="flexSwitchCheckChecked">Cambiar Tipo de Vista: <strong>Datos 8</strong> </label>
                        ...
                        <div class="overflow-hidden ">
                            <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                    <tr v-for="items in ceddato8.data" :key="items.id" class="hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-900">
                                        ...
                                        <td class="py-4 px-6 text-sm font-medium text-gray-500 whitespace-nowrap dark:text-white">{{items.LUGAR_DE_TRABAJO}}</td>
                                        <td class="py-4 px-6 text-sm font-medium text-gray-500 whitespace-nowrap dark:text-white">{{items.SALARIO}}</td>
        ...
        <div class="container max-w-7xl mx-auto  my-4 px-4 sm:px-6 lg:px-8  py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="m-2 bg-gray-200 sm:rounded-lg shadow-md">
                    <h2 class="py-4 px-12 font-bold text-xl">Dato 8</h2>
                    <!-- component -->
                    <div
