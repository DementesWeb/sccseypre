...
use App\Http\Controllers\Dato32Controller;
use App\Http\Controllers\Dato33Controller;
use App\Http\Controllers\Dato34Controller;
use App\Http\Controllers\Dato36Controller;
use App\Http\Controllers\Dato42Controller;
...
use App\Http\Controllers\Dato44Controller;
use App\Http\Controllers\Dato45Controller;
...
Route::get('/dato32', [Dato32Controller::class,'Index'])->name('Dato32');
...
Route::get('/dato44', [Dato44Controller::class, 'Index'])->name('Dato44');
Route::get('/dato45', [Dato45Controller::class, 'Index'])->name('Dato45');
