<template>
    <div v-if="ceddato5.total >= 1">
        <div class="flex justify-center">
            <div class="form-check form-switch">
                <label
                    class="form-check-label inline-block mx-4 text-gray-800"
                    for="flexSwitchCheckChecked"
                    >Cambiar Tipo de Vista: <strong>Base Enero 2022 1</strong>
                </label>
                <button
        ...
        <div v-else>
            <div
                class="container py-6 max-w-7xl mx-auto my-4 px-4 sm:px-6 lg:px-8"
            >
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="m-2 bg-gray-200 sm:rounded-lg shadow-md">
                        <h2 class="py-4 px-12 font-bold text-xl">Base Enero 2022 1</h2>
                        <!-- component -->
                        <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="items-center m-8">
                                            <div
                                                class="flex md:col-start-2 col-span-11 xl:-ml-5 gap-2"
                                            >
