<template>
    <div v-if="dato22.total >= 1">
        <div class="flex justify-center">
            <div class="form-check form-switch">
                <label
                    class="form-check-label inline-block mx-4 text-gray-800"
                    for="flexSwitchCheckChecked"
                    >Cambiar Tipo de Vista: <strong>Planilla SENNIAF 2021</strong>
                </label>
                <button
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <td
                                                    class="py-4 px-6 text-sm font-medium text-gray-500 whitespace-nowrap dark:text-white"
                                                >
                                                    {{ items.DIRECCION_LABORAL }}
                                                </td>
                                                <td
                                                    class="py-4 px-6 text-sm font-medium text-gray-500 whitespace-nowrap dark:text-white"
                                                >
                                                    {{ items.FECHA_DE_NOMBRAMIENTO }}
                                                </td>                                                
                                                <td
                                                    class="py-4 px-6 text-sm font-medium text-gray-500 whitespace-nowrap dark:text-white"
                                                >
                                                    {{ items.CONDICION_LABORAL }}
                                                </td>                                    
                                                <td
            ...
            >
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="m-2 bg-gray-200 sm:rounded-lg shadow-md">
                        <h2 class="py-4 px-12 font-bold text-xl">Planilla SENNIAF 2021</h2>
                        <!-- component -->
                        <div
                        ...
                        <Pagination :pagination="dato22"></Pagination>
                    </div>
                </div>
            </div>
        </div>
