<template>
    <div v-if="ceddato12.total >= 1">
        <div class="flex justify-center">
            <div class="form-check form-switch">
                <label
                    class="form-check-label inline-block mx-4 text-gray-800"
                    for="flexSwitchCheckChecked"
                    >Cambiar Tipo de Vista: <strong>Planilla Diciembre 2020 IDAAN</strong>
                </label>
                <button
            ...
            >
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="m-2 bg-gray-200 sm:rounded-lg shadow-md">
                        <h2 class="py-4 px-12 font-bold text-xl">Planilla Diciembre 2020 IDAAN</h2>
                        <!-- component -->
                        <div
                        ...
                        <Pagination :pagination="ceddato12"></Pagination>
                    </div>
                </div>
            </div>
        </div>
